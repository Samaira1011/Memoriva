...
public class ProfileActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Quick-access cards
        findViewById(R.id.cardAddFriends).setOnClickListener(v ->
                startActivity(new Intent(this, FriendsDiscoverActivity.class)));

        findViewById(R.id.cardMyTrips).setOnClickListener(v ->
                startActivity(new Intent(this, MyTripsActivity.class)));

        findViewById(R.id.cardFutureTrips).setOnClickListener(v ->
                startActivity(new Intent(this, DreamBoardActivity.class)));

        findViewById(R.id.cardTripTimeline).setOnClickListener(v ->
                startActivity(new Intent(this, MyTripsActivity.class)));
